        ...
        <div class="mt-0 text-sm text-[#8ea6c8] flex justify-between items-center">
            ...
            <form action="edit_task.php" method="post">
                <div class="add-items flex">
                    ...
                    <span class="h-12 w-2/12 bg-[#e0ebff] rounded-[7px] flex justify-center text-sm text-[#063c76] font-semibold items-center mr-2"><?= date('Y-m-d H:i', strtotime($editTask['time'])) ?></span>
                    <button
